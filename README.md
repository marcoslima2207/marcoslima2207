...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:161b22,100:238636&height=200&section=header&text=Marcos%20Eduardo&fontSize=45&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=TI%20%7C%20Infraestrutura%20%7C%20Back-end&descAlignY=55&descSize=18" width="100%"/>
...
Estagiário de TI, trabalhando com suporte técnico, troubleshooting e
rotinas de infraestrutura.

Atualmente estou desenvolvendo minhas habilidades em programação,
Linux, automação e desenvolvimento web.

Tenho interesse em evoluir profissionalmente nas áreas de:
...
Sistema web desenvolvido com Django para gerenciamento e catálogo
de jogos digitais.
...
API REST desenvolvida utilizando Node.js, Express, Knex e MySQL.

**Tecnologias:** Node.js • Express • Knex • MySQL
